...
public class Prak11_3 {
	
	public static void tukar(Barang1[] data, int index) {
		Barang1 arrPertama = data[index];
		Barang1 arrKedua = data[index -1];
		//tukar
		data[index] = arrKedua;
	...
	public static void printArr(Barang1[] data) {
	...
	public static void main(String[] args) {
		...
		Barang1 data[] = new Barang1[jumlahdata];
		System.out.println();
